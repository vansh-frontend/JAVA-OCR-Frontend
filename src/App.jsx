                ...
                <div className="space-y-3">
                  {history.map((item, index) => (
                    <motion.div
                      ...
                      className="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-50 group cursor-pointer"
                    ...
                    >
                      ...
                      />
                      <p className="flex-1 truncate text-sm text-gray-600 group-hover:text-gray-900">
                        {item.text}
                      </p>
